  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute -top-11 right-1 z-30 flex items-end gap-1"
      >
        {/* Label */}
        <motion.span
          animate={{ y: [0, -3, 0] }}
          transition={{ duration: 1.8, repeat: Infinity, ease: "easeInOut" }}
          className="mb-1 rounded-full border border-[#79b8ff]/30 bg-[#010409]/90 px-2.5 py-1 text-[10px] font-mono tracking-wide text-[#c9d1d9] shadow-lg shadow-black/40 backdrop-blur-sm whitespace-nowrap"
        >
          play snake!
        </motion.span>
