...
const ProjectCard = ({ project, index }: { project: ProjectsProps; index: number }) => {
    return (
        ...
        >
            ...
            <div className="relative p-6">
                <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                        <h3 className="gradient-text text-xl font-semibold text-white mb-2 group-hover:text-teal-400 transition-colors duration-300">
                            {project.title}
                        </h3>
            ...
            <div className="gradient-border absolute bottom-0 left-0 right-0 h-[2px] from-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
