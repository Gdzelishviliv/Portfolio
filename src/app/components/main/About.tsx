...
const About = () => {
  return (
    <>
      <section id="about" className={`${rancho.variable} ${vt323.variable} mx-4 mt-6 relative flex flex-col gap-5 md:mx-8 md:mt-12 md:flex-row md:gap-12 lg:mx-24 lg:mt-16 lg:gap-16`}>
